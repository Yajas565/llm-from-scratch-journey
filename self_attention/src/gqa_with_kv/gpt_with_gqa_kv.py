...
class GroupedQueryAttention(nn.Module):
    ...
    def __init__(self, d_in, d_out, num_kv_groups, dropout, num_heads, qkv_bias=False):
        super().__init__()
    ...
    def forward(self, x, use_cache=False):
        ...
        queries_new = queries_new.view(b, num_tokens, self.num_heads, self.head_dim).transpose(1,2)
        ...
        if use_cache:
            ...
            keys_base = self.cache_k
            values_base = self.cache_v
        else:
